        ...
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement stmt = conn.prepareStatement(
                     "SELECT b.booking_number, cust.Name AS CustomerName, d.Name AS DriverName, " +
                             ...
                             "b.Distance, (b.Distance * c.RentalPricePerKm * 1.10) AS TotalAmount " + // ✅ Add 10% VAT
                             "FROM booking b " +
            ...
            if (rs.next()) {
                customerName = rs.getString("CustomerName");  // ✅ Fetch Customer Name
                driverName = rs.getString("DriverName");      // ✅ Fetch Driver Name
                carModel = rs.getString("CarModel");          // ✅ Fetch Car Model
