...
<head>
    ...
    <script>
        function downloadBill() {
            ...
            billFrame.src = "downloadBill?bookingID=<%= request.getParameter("bookingID") %>"; // Ensure correct booking ID
            document.body.appendChild(billFrame);

            // Wait for download to start, then redirect after 3 seconds
            setTimeout(function () {
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            try (PreparedStatement stmt = conn.prepareStatement(query)) {
                ...
                if (rs.next()) {
                    ...
                    finalAmount = totalAmount; // Already includes VAT
                }
            }
...
<table>
    ...
    <tr><th>Base Amount</th><td><%= (totalAmount - vat) %> LKR</td></tr>
    <tr><th>VAT (10%)</th><td><%= vat %> LKR</td></tr>
    <tr><th>Total Amount</th><td><strong><%= finalAmount %> LKR</strong></td></tr>
</table>

<!-- Button to download the bill and redirect after downloading -->
